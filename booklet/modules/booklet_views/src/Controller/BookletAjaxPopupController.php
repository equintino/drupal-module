...
namespace Drupal\booklet_views\Controller;
...
/**
 * Default controller for the booklet_views_ajax_popup module.
 */
class BookletAjaxPopupController extends ControllerBase {
  ...
  /**
   * Constructs a new BookletAjaxPopupController object.
   *
  ...
  /**
   * User BookletAjaxPopup page access checker.
   *
  ...
  /**
   * Booklet Ajax Popup build callback..
   *
   * @param \Drupal\Core\Entity\EntityInterface $entity
  ...
  public static function getPopupIdentifierAttribute($entityType, $entityId, $viewMode, $langcode) {
    return sprintf('data-booklet-popup-ajax-entity="%s"', self::getPopupIdentifier($entityType, $entityId, $viewMode, $langcode));
  }
