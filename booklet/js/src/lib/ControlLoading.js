...
(function () {
    ...
    function defineBookletLoading(L) {
        L.Control.Loading = L.Control.extend({
            ...
            onAdd: function(map) {
                if (this.options.spinjs && (typeof Spinner !== 'function')) {
                    return console.error("Booklet.loading cannot load because you didn't load spin.js (http://fgnass.github.io/spin.js/), even though you set it in options.");
                }
                ...
                var classes = 'booklet-control-loading';
                var container;
                if (this.zoomControl && !this.options.separate) {
                    // If there is a zoom control, hook into the bottom of it
                    container = this.zoomControl._container;
                    // These classes are no longer used as of Booklet 0.6
                    classes += ' booklet-bar-part-bottom booklet-bar-part last';

                    // Loading control will be added to the zoom control. So the visible last element is not the
                    // last dom element anymore. So add the part-bottom class.
                    L.DomUtil.addClass(this._getLastControlButton(), 'booklet-bar-part-bottom');
                }
                else {
                    // Otherwise, create a container for the indicator
                    container = L.DomUtil.create('div', 'booklet-control-zoom booklet-control-layer-container booklet-bar');
                }
            ...
            _showIndicator: function() {
                ...
                if (!this.options.separate) {
                    if (this.zoomControl instanceof L.Control.Zoom) {
                        L.DomUtil.removeClass(this._getLastControlButton(), 'booklet-bar-part-bottom');
                    }
                    else if (typeof L.Control.Zoomslider === 'function' && this.zoomControl instanceof L.Control.Zoomslider) {
                        L.DomUtil.removeClass(this.zoomControl._ui.zoomOut, 'booklet-bar-part-bottom');
                    }
                }
            },
            ...
            _hideIndicator: function() {
                ...
                if (!this.options.separate) {
                    if (this.zoomControl instanceof L.Control.Zoom) {
                        ...
                        L.DomUtil.addClass(this.zoomControl._ui.zoomOut, 'booklet-bar-part-bottom');
                    }
                }
            },
            ...
            getEventId: function(e) {
                if (e.id) {
                    ...
                    return e.layer._booklet_id;
                }
                return e.target._booklet_id;
            },
    ...
    if (typeof define === 'function' && define.amd) {
        // Try to add booklet.loading to Booklet using AMD
        define(['booklet'], function (L) {
            defineBookletLoading(L);
        });
    }
    else {
