(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        // AMD
        define(['booklet', 'maplibre-gl'], factory);
    } else if (typeof exports === 'object') {
        // Node, CommonJS-like
        module.exports = factory(require('booklet'), require('maplibre-gl'));
    } else {
    ...
    L.MaplibreGL = L.Layer.extend({
        ...
        onAdd: function (map) {
            ...
            // work around https://github.com/mapbox/mapbox-gl-booklet/issues/47
        ...
        _initContainer: function () {
            var container = this._container = L.DomUtil.create('div', 'booklet-gl-layer');
        ...
        _initGL: function () {
            ...
            L.DomUtil.addClass(canvas, 'booklet-image-layer');
            L.DomUtil.addClass(canvas, 'booklet-zoom-animated');
            if (this.options.interactive) {
                L.DomUtil.addClass(canvas, 'booklet-interactive');
            }
